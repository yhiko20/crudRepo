      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category">Detailed view of: {{ $user->name }}</p>
          </div>
          <!--body-->
          <div class="card-body">
            @if (session('success'))
                ...
                <div class="card card-user">
                  ...
                  <div class="card-footer">
                    <div class="button-container">
                      <a href="{{ route('users.index') }}" class="btn btn-sm btn-success mr-3"> Back </a>
              ...
              <div class="col-md-4">
                <div class="card card-user">
                  ...
                  <div class="card-footer">
                    <!--<div class="button-container">
                      <a href="{{ route('users.index') }}" class="btn btn-sm btn-success mr-3"> Back </a>
                      <a href="#" class="btn btn-sm btn-twitter"> Edit </a>
                    </div>-->
                  </div>
                </div>
              </div>
